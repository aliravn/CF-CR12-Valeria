...
<div class="page-content">
	...
	<a href="p_create.php">
		<button class="btn btn-success" id="add-item-button" type="button">Add user</button>
	</a>
			...
			if($result->num_rows > 0) {
				while($row = $result->fetch_assoc()) {
					...
					"<tr>
						...
						<a class='' href='#?id=" .$row['media_lib_ID']."'><button class='user-manipulate-button' type='button'>Edit</button></a>
